      ...
      >
        <View style={[globalStyles.container]}>
          ...
          <View style={styles.topSection}>
            {/*header*/}
            <GradientText
              style={[globalStyles.gradientHeader, { paddingBottom: 25 }]}
            >
              Settings
            </GradientText>
            <View
            ...
            >
              <View style={[styles.subContainer]}>
                ...
                <TouchableOpacity
                  onPress={() => router.push("/garageManagement")}
                >
                  <View
                    style={[
                      styles.settingsContainer,
              ...
              <View style={[styles.subContainer, { paddingTop: 25 }]}>
                <GradientText
                  style={[globalStyles.gradientH2, { paddingTop: 15 }]}
                >
                  More
                </GradientText>
