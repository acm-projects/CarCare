        ...
        >
          <View style={[styles.subContainer]}>
            ...
            <Text style={globalStyles.grayP}>
              CarCare needs your car's VIN number to display accurage
              information regarding your vehicle. CarCare also collects user
              location data to display your local mechanics. CarCare uses
              third-party tools to store data.
            </Text>
            <Text
              style={[globalStyles.grayP, { color: "#3272ae" }]}
              onPress={() =>
